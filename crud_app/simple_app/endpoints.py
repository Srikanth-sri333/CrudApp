...
con_string = "mongodb+srv://srikanth:mailatgoogle@cluster0.dva0qht.mongodb.net/?retryWrites=true&w=majority "

client = pymongo.MongoClient(con_string)

db = client.get_database('sample')

user_collection = pymongo.collection.Collection(db, 'samplework') #(<database_name>,"<collection_name>")
